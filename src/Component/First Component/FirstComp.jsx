...
import "../First Component/FirstComp.css";
...
const FirstComp = () => {
  ...
  return (
    <div>
      <Header />
      {/* <div className={`buttons ${showModal ? 'blur-background' : ''}`}> */}
      <div className="buttons">
        <button className="btn" onClick={handleShowToast}>
          Show Toast Message
        </button>
        <button className="btn-setting" onClick={handleShowModal}>
          <svg
      ...
      {showToast && (
        <div className="msg">
          <p className="para">Testing : {count} </p>
